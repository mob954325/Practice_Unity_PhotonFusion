...
namespace Asteroids.HostSimple
{
    ...
    {
        // 풀에 들어갈 오브젝트들, 모든 네트워크 오브젝트를 풀에서 관리한다면 비워도 된다.
        ...
        protected override void DestroyPrefabInstance(NetworkRunner runner, NetworkPrefabId prefabId, NetworkObject instance)
        {
            ...
            {
                Destroy(instance.gameObject);               // 관리 하는 오브젝트는 그냥 삭제
            }
        }
        ...
        {
            NetworkObject instance = Instantiate(prefab);   // 생성
        ...
        /// <returns>true면 풀에서 관리할 오브젝트, false면 아님</returns>
        private bool ShouldPool(NetworkRunner runner, NetworkObject prefab)
        {
            ...
            return IsPoolableObject(prefab);    // _poolableObjects에 등록된 오브젝트가 없으면 모두 풀에서 관리
        }
        ...
        /// <returns>_poolableObjects에 등로고딘 오브젝트이면 true 아니면 false</returns>
