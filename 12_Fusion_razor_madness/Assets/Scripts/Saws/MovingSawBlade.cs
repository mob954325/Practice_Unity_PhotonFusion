...
public class MovingSawBlade : SawBlade
{
    ...
    public override void Spawned()
    {
        ...
        //_desiredPos = _positions[0];        // 목표 지점은 리스트의첫번째로 지정
        _posIndex = 0;                      // 인덱스 0으로 설정
        _desiredPos = _positions[_posIndex];// 목표 지점은 리스트의 첫 번째로 지정
    }
    ...
    public override void FixedUpdateNetwork()
    {
        ...
        if (_delta >= 1)    // 도착했으면
        {
            ...
            _desiredPos = _positions[_posIndex];    // 다음 목표지점 설정
        }
    }
